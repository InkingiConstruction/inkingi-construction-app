    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#f8fafc", padding: 20 }}>
      <View style={{ gap: 12 }}>
        ...
        <Text style={{ color: "#64748b", fontSize: 14, lineHeight: 20 }}>
          Select a supervisor for project quality review.
        </Text>
        <View
          style={{
        ...
        >
          <Text style={{ color: "#334155", fontSize: 14 }}>Use GET /api/v1/users/supervisors and POST /api/v1/project-members.</Text>
        </View>
      </View>
    </SafeAreaView>
  );
